...
declare type NodemonEventHandler =
  | 'start'
  | 'crash'
  | 'exit'
  | 'quit'
...
declare type NodemonEventListener = {
...
declare interface NodemonEventRestart {
  matched?: {
    result: string[];
    total: number;
  };
...
declare type NodemonEventQuit = 143 | 130;

declare type NodemonEventConfig = {
  run: boolean;
  system: {
    cwd: string;
  };
...
declare interface NodemonExecOptions {
  script: string;
...
declare interface NodemonConfig {
...
declare interface NodemonSettings extends NodemonConfig, NodemonExecOptions {
  events?: Record<string, string>;
  env?: Record<string, string>;
}

declare type Nodemon = {
